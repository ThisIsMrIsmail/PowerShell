...
$global:_ompExecutable = 'C:/Users/ismai/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe'
...
New-Module -Name "oh-my-posh-core" -ScriptBlock {
    ...
    $env:POSH_SESSION_ID = '56d904e6-60ca-4587-9870-cd2bead50a25'
    $env:CONDA_PROMPT_MODIFIER = $false

    # set the default theme
    if ('C:\Users\ismai\Documents\PowerShell\thisismrismail.omp.json' -and (Test-Path -LiteralPath 'C:\Users\ismai\Documents\PowerShell\thisismrismail.omp.json')) {
        $env:POSH_THEME = (Resolve-Path -Path 'C:\Users\ismai\Documents\PowerShell\thisismrismail.omp.json').ProviderPath
    }
